...
import { Qaf } from '../navigation/qaf';
import { PopupLink } from '../components/popup-link';
import { PopupMenu } from '../components/popup-menu';
import { VerseSelector } from '../navigation/verse-selector';
import { HamburgerMenu } from '../navigation/hamburger-menu';
import { container } from 'tsyringe';
import hamburger from './../images/icons/hamburger.svg'
import './navigation-bar2.scss';

export const NavigationBar2 = ({ chapterNumber, url }: NavigationProps) => {
