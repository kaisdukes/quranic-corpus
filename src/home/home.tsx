    ...
    return (
        <div className='home'>
            ...
            <p className='intro'>
                ...
                An AI analyzed the entire quran, and the resulting data was reivewed by experts, to provide insights into the Quran's structure (syntax), word
            ...
            <p style={{marginTop: 0}}>
                ...
                based on <em>i’rāb</em> (إعراب), the traditional Arabic science of linguistics.
            </p>
            <p className='wbw'>
